...
In this project, I analyzed a gene expression dataset from tumor tissues of muscle-invasive bladder cancer (MIBC) patients that received platinum-based neoadjuvant chemotherapy (NAC) prior to radical cystectomy (RC). The goal was to identify biomarkers that differentiate patients that achieve a pathologic response to NAC from those that are NAC resistant.

The analysis was performed using R within a Quarto markdown file (Final_markdown_Peffer.qmd). Quarto is Posit's enhanced version of R Markdown that offers multi-language and multi-engine support. The original rendered HTML output from the Quarto markdown can be viewed [here](https://html-preview.github.io/?url=https://github.com/PhilipPeffer/MIBC_transcriptomic_biomarkers/blob/main/Scripts/Final_markdown_Peffer.html). This README was created from a version of the Quarto file modified to output to GitHub Flavored Markdown. The original code from the Quarto markdown file has also been copied to a standalone R script (Analysis_script.R) for easier viewing on GitHub.


# Exploratory analysis

```{r 1.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
...
```{r 1.2, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
# read in patient phenotype data
p_data <- read.table("../Data/Discovery/GSE169455_pdata.txt", header=T, sep='\t', row.names=NULL)
p_data[1:10,1:10]
```

```{r 1.3, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
...
```{r 1.4, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
par(mfrow=c(1,1))
boxplot(neo_eset)
```

```{r 1.5, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
library(ggplot2)
...
```{r 1.6, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 10, fig.height = 12}
...
```{r 2.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
...
```{r 2.2, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE}
...
```{r 2.3, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 10}
...
![GSEA overlap results - significant gene sets table](https://github.com/PhilipPeffer/MIBC_transcriptomic_biomarkers/blob/main/Results/CR_GS_overlap1.png?raw=true)\
![GSEA overlap results - gene/geneset overlap matrix](https://github.com/PhilipPeffer/MIBC_transcriptomic_biomarkers/blob/main/Results/CR_GS_overlap2.png?raw=true)\

# Gene Co-expression (WGCNA) Analysis

```{r 3.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 10, fig.height = 8}
...
GSEA overlap results (FDR < 0.05):\
![GSEA overlap results - significant gene sets table](https://github.com/PhilipPeffer/MIBC_transcriptomic_biomarkers/blob/main/Results/CR_WGCNA_overlap1.png?raw=true)\
![GSEA overlap results - gene/geneset overlap matrix](https://github.com/PhilipPeffer/MIBC_transcriptomic_biomarkers/blob/main/Results/CR_WGCNA_overlap2.png?raw=true)\

# ssGSEA and survival analysis

```{r 4.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
...
```{r 4.2, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
sig_group <- c()
...
```{r 4.3, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
# survival analysis
library(survival)
...
```{r 5.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
...
```{r 6.1, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
...
```{r 6.2, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
...
```{r 6.3, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
...
```{r 6.4, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, class.source = "fold-show", cache=FALSE, fig.width = 8, fig.height = 8}
##insall pakcages if needed
# BiocManager::install("singscore")
# BiocManager::install("SummarizedExperiment")
# BiocManager::install("GSEABase")
