...
format:
  html:
    ...
    self-contained: true  # Ensures a single HTML file with embedded resources
    link-external: true
  # pdf:
  #   toc: true
fontsize: 12pt
...
![GSEA overlap results - significant gene sets table](../Results/CR_GS_overlap1.png)\
![GSEA overlap results - gene/geneset overlap matrix](../Results/CR_GS_overlap2.png)\
...
GSEA overlap results (FDR < 0.05):\
![GSEA overlap results - significant gene sets table](../Results/CR_WGCNA_overlap1.png)\
![GSEA overlap results - gene/geneset overlap matrix](../Results/CR_WGCNA_overlap2.png)\
